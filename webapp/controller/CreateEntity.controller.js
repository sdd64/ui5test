sap.ui.define([
	...
	return BaseController.extend("acando.blog.fiori.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("SalesOrderSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("SalesOrderSet", oData);
