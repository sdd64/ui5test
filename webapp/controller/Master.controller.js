/*global history */
sap.ui.define([
	"acando/blog/fiori/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"acando/blog/fiori/model/formatter",
	"sap/m/MessageBox",
	"acando/blog/fiori/model/grouper",
	"acando/blog/fiori/model/GroupSortState"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("acando.blog.fiori.controller.Master", {
		...
		onInit: function() {
			...
			this._oGroupSortState = new GroupSortState(oViewModel, grouper.GrossAmount(this.getResourceBundle()));
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("acando.blog.fiori.view.ViewSettingsDialog", this);
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							SalesOrderID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("SalesOrderID"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				SalesOrderID: encodeURIComponent(oItem.getBindingContext().getProperty("SalesOrderID"))
			}, bReplace);
		},
